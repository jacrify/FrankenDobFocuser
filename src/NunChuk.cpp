...
void NunChuk::setUpNunChuk() {
  ...
  controller.setModeParameters(0, 200, 1000);
  controller.setModeParameters(1, 1000, 4000);
  controller.setModeParameters(2, 4000, 16000);
  controller.setModeParameters(3, 16000, 64000);
}
